...
function createJunction(ind,i){
    ...
    junc.style = "z-index: 10000; position:absolute; width: 108px; height: 108px; background-color: red; pointer-events: none; opacity:0.65; animation-name: colorShift; animation-duration: 12s; animation-iteration-count: infinite;";
    //Calculate position
    let x = i%8;
    let y = Math.floor(i/8);
    junc.style.top = 395 + (y*108);
    junc.style.left = 108 * (x+1);
    //Add element to page
    anim.after(junc);
    //Define geometry
    switch (ind){
        case "1":
            junc.style.clipPath = "polygon(54px 50px,109px 50px,109px 58px,54px 58px)";
            return;
        case "2":
            junc.style.clipPath = "polygon(50px 54px,50px 109px,58px 109px,58px 54px)";
            return;
        case "3":
            junc.style.clipPath = "polygon(0px 50px,54px 50px,54px 58px,0px 58px)";
            return;
        case "4":
            junc.style.clipPath = "polygon(50px 0px,50px 54px,58px 54px,58px 0px)";
            return;
        case "5":
            junc.style.clipPath = "polygon(50px 0px,50px 109px,58px 109px,58px 0px)";
            return;
        case "6":
            junc.style.clipPath = "polygon(0px 50px,109px 50px,109px 58px,0px 58px)";
            return;
        case "7":
            junc.style.clipPath = "polygon(50px 0px,50px 58px,109px 58px,109px 50px,58px 50px,58px 0px)";
            return;
        case "8":
            junc.style.clipPath = "polygon(50px 109px,50px 50px,109px 50px,109px 58px,58px 58px,58px 109px)";
            return;
        case "9":
            junc.style.clipPath = "polygon(0px 50px,58px 50px,58px 109px,50px 109px,50px 58px,0px 58px)";
            return;
        case "A":
            junc.style.clipPath = "polygon(0px 58px,58px 58px,58px 0px,50px 0px,50px 50px,0px 50px)";
            return;
        case "B":
            junc.style.clipPath = "polygon(50px 0px,50px 109px,58px 109px,58px 58px,109px 58px,109px 50px,58px 50px,58px 0px)";
            return;
        case "C":
            junc.style.clipPath = "polygon(0px 50px,109px 50px,109px 58px,58px 58px,58px 109px,50px 109px,50px 58px,0px 58px)";
            return;
        case "D":
            junc.style.clipPath = "polygon(58px 0px,58px 109px,50px 109px,50px 58px,0px 58px,0px 50px,50px 50px,50px 0px)";
            return;
        case "E":
            junc.style.clipPath = "polygon(0px 58px,109px 58px,109px 50px,58px 50px,58px 0px,50px 0px,50px 50px,0px 50px)";
            return;
        case "F":
            junc.style.clipPath = "polygon(0px 58px,50px 58px, 50px 109px, 58px 109px, 58px 58px, 109px 58px,109px 50px,58px 50px,58px 0px,50px 0px,50px 50px,0px 50px)";
            return;
    }
}
